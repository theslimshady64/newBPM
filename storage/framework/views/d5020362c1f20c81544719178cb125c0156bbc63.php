<div class="modal fade" id="editFolderModal" tabindex="-1" role="dialog" aria-labelledby="editFolderLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('editFolder')); ?>" enctype="multipart/form-data" method="post">
                <?php echo csrf_field(); ?>
...
<?php /**PATH D:\OSPanel\domains\BPM\resources\views/pmo/files/editFolder.blade.php ENDPATH**/ ?>