<div class="modal fade" id="createFolderModal" tabindex="-1" role="dialog" aria-labelledby="createFolderLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('createFolder')); ?>" enctype="multipart/form-data" method="post">
                <?php echo csrf_field(); ?>
...
<?php /**PATH D:\OSPanel\domains\BPM\resources\views/pmo/files/createFolder.blade.php ENDPATH**/ ?>